		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zc07c07sample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zc07c07sample-display": {
								"semanticObject": "zc07c07sample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zc07.c07.sample",
									"url": sap.ui.require.toUrl("zc07/c07/sample")
								}
							}
						}
					}
